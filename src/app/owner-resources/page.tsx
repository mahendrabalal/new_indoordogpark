    ...
    <PageLayout>
      <section className="bg-gradient-to-br from-slate-900 to-violet-900 py-20 text-white">
        <div className="mx-auto max-w-5xl px-4 text-center">
          ...
          <p className="mt-4 text-lg text-slate-200">We package the tools, coaching, and benchmarks that top operators use to launch, scale, and delight their communities.</p>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="mb-8 text-center">
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">
              ...
              we&rsquo;ve curated resources based on real-world experience from successful operators.
            </p>
          </div>
