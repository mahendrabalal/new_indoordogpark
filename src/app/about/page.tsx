        ...
        <section className="about-modern-section" style={{ padding: '40px 20px' }}>
          <div className="about-modern-container">
            ...
            <p className="about-modern-text" style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto 40px', fontSize: '1.1rem' }}>
              Choosing the right indoor dog park involves considering several important factors to ensure a safe, enjoyable experience for both you and your pet. Check out our <Link href="/how-it-works" style={{ color: '#2c3e50', textDecoration: 'underline', fontWeight: 600 }}>guide on how to use our directory</Link> and explore <Link href="/blog" prefetch={false} style={{ color: '#2c3e50', textDecoration: 'underline', fontWeight: 600 }}>helpful articles</Link> for more tips.
            </p>
            <div className="about-modern-values-grid">
              <div className="about-modern-value-card">
                <div className="value-icon-modern value-icon-green">
          ...
          <div className="about-modern-container">
            <div className="about-modern-content-layout">
              ...
              <div className="about-modern-text-content">
                ...
                <p className="about-modern-text">
                  The indoor dog park industry has experienced significant growth over the past decade, driven by changing climate patterns, increased urbanization, and a greater understanding of canine wellness needs. What began as a niche concept in metropolitan areas has expanded into a nationwide movement. Major cities across the United States now host multiple indoor dog park facilities, each offering unique amenities and services. From basic climate-controlled play spaces to luxury facilities featuring swimming pools, grooming salons, and cafés, the industry continues to evolve to meet diverse owner and pet needs. Explore facilities by <Link href="/states" style={{ color: '#2c3e50', textDecoration: 'underline', fontWeight: 600 }}>state</Link> or read more about this trend in our <Link href="/blog" prefetch={false} style={{ color: '#2c3e50', textDecoration: 'underline', fontWeight: 600 }}>blog</Link>.
                </p>
                <p className="about-modern-text">
