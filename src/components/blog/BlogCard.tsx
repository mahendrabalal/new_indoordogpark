...
export default function BlogCard({
  ...
  return (
    <Link
      href={`/blog/${post.slug}`}
      className={`group flex h-fit flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${className}`}
    >
      {/* Featured Image with Tags Overlay */}
      <div className="relative block aspect-[16/9] overflow-hidden bg-gray-100">
        <Image
          src={imageSrc}
          ...
          unoptimized={imageSrc.startsWith('http') || imageSrc.startsWith('/images/')}
        />
        {/* Tags Overlay */}
      ...
      <div className="flex flex-col p-5">
        ...
        {/* Read More CTA */}
        <div className="mt-auto inline-flex items-center text-sm font-semibold text-[#FF5722] transition-colors group-hover:text-[#E64A19]">
          Read more
