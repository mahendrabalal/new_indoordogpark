  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        { name: 'climateControl', type: 'boolean', title: 'Climate Control' },
        { name: 'daycare', type: 'boolean', title: 'Daycare' },
        { name: 'dogWashStation', type: 'boolean', title: 'Dog Wash Station' },
        { name: 'fencing', type: 'boolean', title: 'Fencing' },
        { name: 'foodAllowed', type: 'boolean', title: 'Food Allowed' },
        { name: 'grooming', type: 'boolean', title: 'Grooming' },
        { name: 'handicapAccess', type: 'boolean', title: 'Handicap Access' },
        { name: 'lighting', type: 'boolean', title: 'Lighting' },
        { name: 'misters', type: 'boolean', title: 'Misters' },
        { name: 'restrooms', type: 'boolean', title: 'Restrooms' },
        { name: 'socializing', type: 'boolean', title: 'Socializing' },
        { name: 'training', type: 'boolean', title: 'Training' },
      ],
    }),
    defineField({
      name: 'rules',
      ...
      fields: [
        ...
        { name: 'privateBookingAvailable', type: 'boolean', title: 'Private Booking Available' },
        { name: 'staffSupervised', type: 'boolean', title: 'Staff Supervised' },
      ],
    }),
    defineField({
      name: 'pricingInfo',
